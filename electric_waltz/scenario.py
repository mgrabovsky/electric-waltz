...
class Scenario:
    ...
    def run(self) -> ScenarioRun:
        ...
        for i in range(num_steps):
            gross_consumption = self._demand[i] * (1 + self._losses)
    ...
    def _step(self, consumption: Power) -> Power:
        """
        Returns:
            Electricity shortage, i.e. amount of demand not met by the grid (positive)
        ...
        # Return shortage if the previous failed to satisfy demand.
        # FIXME: What to do about this?
